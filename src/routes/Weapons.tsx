  ...
  return (
    <>
      ...
      <div className="weapons-note">
        All weapons have their damage and deadliness displayed in the format of "1h/2h"<br/><br/>
        If a weapon has multiple ways of using it, the two possibilities will be shown as "1h/2h or 1h/2h"<br/><br/>
      </div>
      </section>
    </>
  );
