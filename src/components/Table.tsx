...
const TableHeader = <T, K extends keyof T>({ columns }: TableColProps<T, K>): JSX.Element => {
...
const TableRows = <T, K extends keyof T>({ data, columns }: TableRowProps<T, K>): JSX.Element => {
...
export function Table<T, K extends keyof T>({ data, columns }: TableProps<T, K>): JSX.Element {
  return (
    <div className='table'>
